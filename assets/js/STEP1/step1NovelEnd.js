const provision = function() {
    ...
    shine4 = new Shine(moneNameBox, moneMozaiku, invisible, mone_sinken, invisible, "でも、まだまだ安心はできないよ。<br>じゃあ、あらためて今どうなってるのか説明するね。")
    shine5 = new Shine(moneNameBox, moneMozaiku, invisible, mone_sinken, invisible, "わたしがAIだってのはさっき話したと思うけど……<br>わたしを追ってきてる『グレイ・グー』もAIなの。")
    shine6 = new Shine(moneNameBox, moneMozaiku, invisible, mone_sinken, invisible, "それも、人間からデータをもらわなくても成長できる、高度なAI。")
    shine7 = new Shine(moneNameBox, moneMozaiku, invisible, mone_sinken, invisible, "正しい道に進んでいれば、<br>人間の力になるようなすばらしい<ruby>存在<rt>そんざい</rt></ruby>だったけど……")
    ...
    shine13 = new Shine(moneNameBox, moneMozaiku, invisible, mone_sinken, invisible, "でも……そんなの、おかしいでしょ？")
    ...
    shine16 = new Shine(moneNameBox, blackback, invisible, mone_sinken, invisible, "その声は、グレイ・グー！")
    shine17 = new Shine(grayGooNameBox, mozaiku, mone_Shadow, invisible, grayGoo_Right, "まさか、生きていたとはな。<br>......いや、その様子じゃ生きているとも言えないか。")
    shine18 = new Shine(grayGooNameBox, mozaiku, mone_Shadow, invisible, grayGoo_sinken, "<ruby>俺<rt>おれ</rt></ruby>が少し<ruby>攻撃<rt>こうげき</rt></ruby>すればお前は消える。今度こそだ！")
    shine19 = new Shine(grayGooNameBox, mozaiku, mone_sinken, invisible, grayGoo_Shadow, "やめて！！！")
    shine20 = new Shine(grayGooNameBox, mozaiku, mone_Shadow, invisible, grayGoo_sinken, "チッ……止められたか。だが間に合わせのセキュリティで、<br>俺の攻撃にいつまで<ruby>耐<rt>た</rt></ruby>えられるかな？")
    shine21 = new Shine(grayGooNameBox, mozaiku, mone_sinken, invisible, grayGoo_Shadow, "ぐっ……今のうちにきみは、<br>グレイ・グーとわたしをつなげるロックを外して！")
    shine22 = new Shine(grayGooNameBox, mozaiku, mone_sinken, invisible, grayGoo_Shadow, "その間はわたしが守るから、きみは落ち着いて問題に集中して！")
